...
airbender = media.Movie("The last airbender",
    """the twelve-year old (chronologically 112) incarnation of the current Avatar 
    and the eponymous""",
    "http://static.tvtropes.org/pmwiki/pub/images/ATLA_3829.jpg",
    "https://www.youtube.com/watch?v=Rz7EsOua-D4")

"""adding pitch perfect. storyline was too long and was going off the text editor's 
screen. Looked longer than 80 characters. Decided to shorten it. When put it into 
...
pitch_perfect = media.Movie("Picth Perfect",
    ...
    school's all-girls singing group. Injecting some much needed energy into their 
    repertoire, The Bellas take on their male rivals in a campus competition.""",
...
grudge = media.Movie("The Grudge",
    ...
    supernatural curse one that locks a person in a powerful rage before claiming 
